...
CREATE UNIQUE INDEX comment_upvotes_idx ON comment_upvotes (user_id, comment_id);
CREATE UNIQUE INDEX post_tags_idx ON post_tags (post_id, tag_name);
CREATE UNIQUE INDEX tags_blacklist_idx ON tags_blacklists (user_id, tag_name);
...
CREATE UNIQUE INDEX users_blacklist_idx ON users_blacklists (user_id, blocked_by_user_id);
